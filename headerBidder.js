    ...
    , function(t, e, n) {
        ...
        var r = n(1)
          ...
          , z = function(t) {
            function e() {
                return u()(this, e),
                  x()(this, L()(e).apply(this, arguments))
            }
            return O()(e, t),
              e
        }(j()(Error))
          ...
          , C = function() {
            ...
            var e, n, r, s, a, c, f, p, m, y, w, k, x;
            return l()(t, [{
                key: "setKey",
                value: (x = o()(i.a.mark((function t(e) {
                ...
                key: "setTags",
                value: (m = o()(i.a.mark((function t(e) {
                        return i.a.wrap((function(t) {
                              for (; ; )
                                  switch (t.prev = t.next) {
                                      case 0:
                                          if (this.validateTags(e),
                                            !Array.isArray(e)) {
                                              t.next = 10;
                                              break
                                          }
                ...
                value: (a = o()(i.a.mark((function t(e) {
                        return i.a.wrap((function(t) {
                              for (; ; )
                                  switch (t.prev = t.next) {
                                      case 0:
                                  ...
                                  switch (t.prev = t.next) {
                                      ...
                                      case 20:
                                          return t.t9 = t.sent,
                                            ...
                                            t.abrupt("return", this.apiClient.sendEvent(s, !1));
                                      case 27:
                                          throw b.error("No session"),
                                            new M;
                                      case 29:
                                  ...
                                  switch (t.prev = t.next) {
                                      ...
                                      case 24:
                                          return t.t10 = t.sent,
                                            ...
                                            t.abrupt("return", this.apiClient.sendEvent(s, !0));
                                      case 29:
                                      case "end":
                                          return t.stop()
                                  }
          ...
          , tt = function() {
            ...
            return l()(t, [{
                ...
                key: "sendEvent",
                value: (s = o()(i.a.mark((function t(e, n) {
                        return i.a.wrap((function(t) {
                              for (; ; )
                                  switch (t.prev = t.next) {
                                      case 0:
                                  ...
                                  switch (t.prev = t.next) {
                                      ...
                                      case 2:
                                          for (n = t.sent,
                                              ...
                                              r = this.events.splice(0, this.batchSize),
                                                b.debug("Flushing " + r.length + " events"),
                                              r.length && function() {
                                                  var t = {};
                                                  r.forEach((function(e) {
                                                    ...
                                                    n ? navigator.sendBeacon && e ? s.beacon(n, t) : s.axios(n, t) : b.warn("missing ingestion key")
                                              }();
                                      case 6:
                                          return t.prev = 6,
                                            t.next = 9,
                ...
                value: function(t, e) {
                    ...
                    navigator.sendBeacon("https://analytics.leya.tech/events?xat=" + t, n) || (b.debug("failed to queue beacon request, falling back to axios"),
                      this.axios(t, e))
                }
            }, {
                key: "axios",
                value: function(t, e) {
                    Z.a.post("https://analytics.leya.tech/events", JSON.stringify(e), {
                        headers: {
...
var streamampConfig = {
    ...
    "adUnits": [{
        "bids": [{
            "bidder": "conversant",
            "labelAny": ["971-9999", "729-970", "0-728", "971-9999"],
            "params": {
                "site_id": "201189"
            }
        }, {
            "bidder": "criteo",
            "labelAny": ["971-9999", "729-970", "0-728"],
            "params": {
            ...
            "labelAny": ["971-9999", "971-9999"],
            "params": {
                "nq": "StreamAMP",
                "pid": "5e8ded7d0ae8996ff06b20a2"
            }
        }, {
            "bidder": "openx",
            "labelAny": ["971-9999", "729-970", "0-728", "971-9999"],
        ...
        "breakpoints": {
            "0-728": [[300, 250]],
            "729-970": [[300, 250]],
            "971-9999": [[300, 250], [300, 600], [300, 1050]]
        },
        "code": "ukbf-mpu-2",
        "isSticky": false,
        "mediaTypes": {
        ...
        "bids": [{
            "bidder": "conversant",
            "labelAny": ["0-728", "971-9999", "729-970", "971-9999"],
            "params": {
                "site_id": "201189"
            }
        }, {
            ...
            "labelAny": ["0-728"],
            "params": {
                "adSlot": "Sift-ukbf_top_320x50@320x50Sift-ukbf_top_320x50@320x50",
                "pmzoneid": "2237793",
                "publisherId": "127864"
            }
        }, {
        ...
        "breakpoints": {
            "0-728": [[320, 50]],
            "729-970": [[468, 60], [728, 90]],
            "971-9999": [[728, 90], [970, 90], [970, 250]]
        },
        "code": "ukbf-top",
        "isSticky": false,
        "mediaTypes": {
    ...
    "adUnitsToRefresh": ["ukbf-mpu", "UKBF_Sticky"],
    ...
    "breakpoints": [{
        ...
        "maxWidth": 9999,
        "minWidth": 971,
        "sizesSupported": [[300, 250], [300, 600], [300, 1050], [728, 90], [970, 90], [970, 250], [1, 1]]
    }, {
        "label": "729-970",
        "maxWidth": 970,
        "minWidth": 729,
        "sizesSupported": [[300, 250], [468, 60], [728, 90], [1, 1]]
    }, {
        "label": "0-728",
        "maxWidth": 728,
        "minWidth": 0,
...
var dnsUrls = {
    ...
    prebid: 'https://cdn.jsdelivr.net/gh/streamAMP/client-configs/prebid/prebid-3.12.0.js',
...
Leya.addTags(["leya_version", "1.0.15"]);
