    ...
    googletag.cmd.push(function() {
        ...
        function gptSizeMappingDefineSlots() {
            return streamampConfig.adUnits.map(function(adUnit) {
                var gptSlot = googletag.defineSlot(adUnit.path, adUnit.mediaTypes.banner.sizes, adUnit.code).defineSizeMapping(allBreakpointsSizeMapping(adUnit.mediaTypes.banner.sizes)).addService(googletag.pubads())
