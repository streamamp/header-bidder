...
, function(t, e, n) {
    ...
    var r = n(3)
      ...
      , h = function(t) {
        function e() {
            return i()(this, e),
            o()(this, u()(e).apply(this, arguments))
        }
        return l()(e, t),
        e
    }(n.n(f)()(Error))
...
, function(t, e, n) {
    ...
    o.rgb.hsv = function(t) {
        var e, n, r, i, s, o = t[0] / 255, a = t[1] / 255, u = t[2] / 255, c = Math.max(o, a, u), l = c - Math.min(o, a, u), f = function(t) {
            return (c - t) / 6 / l + .5
        };
...
, function(t, e, n) {
    ...
    (function(e) {
        ...
        var a, u = {
            adapter: (("undefined" != typeof XMLHttpRequest || void 0 !== e && "[object process]" === Object.prototype.toString.call(e)) && (a = n(24)),
            a),
...
, function(t, e, n) {
    var r = function(t) {
        ...
        return f.prototype = m.constructor = h,
        h.constructor = f,
            ...
            return i.a.wrap((function(t) {
                for (; ; )
                    ...
                    case 3:
                        ...
                        n(r);
                    case 6:
                        return window.setInterval(o()(i.a.mark((function t() {
                            var e;
                            return i.a.wrap((function(t) {
                                for (; ; )
                                    switch (t.prev = t.next) {
...
, function(t, e, n) {
    ...
    var r = n(1)
        ...
        return l()(t, [{
            ...
            value: function(e) {
                ...
                return Object.keys(e.bidders).forEach((function(t) {
                    return r.push(g.from(e.bidders[t]))
                }
                )),
                n.bidders = r,
                n
        ...
        return l()(t, [{
            ...
            value: function(e) {
                ...
                return Object.keys(e.adUnits).forEach((function(t) {
                    return r.push(m.from(e.adUnits[t]))
                }
                )),
                n.adunits = r,
                n
      ...
      , v = function() {
        function t() {
            ...
            h()(this, "_gdprc", null),
            h()(this, "_tags", []),
            h()(this, "_ad_unit", null),
            h()(this, "_winner", null),
            h()(this, "_cpm", null),
            h()(this, "_media_type", null),
            h()(this, "_size", null),
            h()(this, "_auction_start", null),
            h()(this, "_auction_finish", null),
            h()(this, "_timeout", null),
            h()(this, "_auction_id", null),
            h()(this, "_status", null),
            h()(this, "_bidders", [])
        }
        return l()(t, [{
            ...
            value: function(e) {
                ...
                return Object.keys(e.auction.bidders).forEach((function(t) {
                    return r.push(g.from(e.auction.bidders[t]))
                }
                )),
                n.bidders = r,
                n
      ...
      , b = function() {
        function t() {
            ...
            h()(this, "_cpm", null),
            h()(this, "_bidder", null),
            h()(this, "_bidder_start", null),
            h()(this, "_bidder_finish", null),
            h()(this, "_media_type", null),
            h()(this, "_size", null),
            h()(this, "_auction_id", null),
            h()(this, "_auction_start", null),
        ...
        return l()(t, [{
            ...
            value: (r = o()(i.a.mark((function t(e) {
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 11:
                            return s = t.sent,
                            p.a.debug("Handling Prebid Auction event on session " + n.id),
                            (o = y.from(e)).session = n.id,
                            o.host = n.host,
                            o.path = n.path,
                            ...
                            o.tags = w.sanitizeTags(s),
                            p.a.debug("Flattening auction event: " + JSON.stringify(o)),
                            a = this.flattenAuction(o),
                            p.a.debug("Flattened auction rows: " + JSON.stringify(a)),
                            u = {
                                type: x,
                                data: a
                            },
            ...
            value: (n = o()(i.a.mark((function t(e) {
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 11:
                            return s = t.sent,
                            p.a.debug("Handling Prebid Impression event on session " + n.id),
                            (o = v.from(e)).session = n.id,
                            o.host = n.host,
                            o.path = n.path,
                            o.referrer = n.referrer,
                            o.device = r.device,
                            ...
                            o.gdprvl = r.gdpr.vendorListVersion,
                            o.tags = w.sanitizeTags(s),
                            p.a.debug("Flattening impression event: " + JSON.stringify(o)),
                            a = this.flattenImpression(o),
                            p.a.debug("Flattened impression rows: " + JSON.stringify(a)),
                            u = {
                                type: L,
                                data: a
                            },
            ...
            value: (e = o()(i.a.mark((function t(e) {
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 11:
                            return s = t.sent,
                            p.a.debug("Handling Prebid BidAfterTimeout event on session " + n.id),
                            (o = b.from(e)).session = n.id,
                            o.host = n.host,
                            o.path = n.path,
                            o.referrer = n.referrer,
                            o.device = r.device,
                            ...
                            o.gdprvl = r.gdpr.vendorListVersion,
                            o.tags = w.sanitizeTags(s),
                            p.a.debug("Flattening BidAfterTimeout event: " + JSON.stringify(o)),
            ...
            value: function(t) {
                ...
                return t.adunits.forEach((function(n) {
                    w.emptyArray(n.sizes) ? n.bidders.forEach((function(r) {
                        e.push({
                            session: t.session,
                            host: t.host,
                            referrer: t.referrer,
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 20:
                            ...
                            p.a.debug("Recording page view event " + JSON.stringify(s)),
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 9:
                            ...
                            throw p.a.error("Session is still open"),
                            new T.a;
                        case 12:
                            return t.t0 = e.id,
                            t.t1 = e.host,
                        ...
                        case 24:
                            ...
                            p.a.debug("Recording session closed event " + JSON.stringify(s)),
                            t.abrupt("return", this.apiClient.sendEvent(s));
                        case 29:
                        case "end":
                            return t.stop()
      ...
      , q = function(t) {
        function e() {
            return u()(this, e),
            N()(this, R()(e).apply(this, arguments))
        }
        return U()(e, t),
        e
    }(F()(Error))
      ...
      , $ = function() {
        ...
        return l()(t, [{
                    ...
                    for (; ; )
                        ...
                        case 0:
                            return t.abrupt("return", this.apiClient.getA9LineItemsMap().then((function(t) {
                                ...
                                p.a.debug("A9 Line Items map: " + JSON.stringify(e.lineItemsMap))) : p.a.warn("Retrieved empty line items map, review configuration.")
                            }
                            )).catch((function(t) {
                                throw p.a.error("API error fetching A9 Line Items Map", t),
                                new V
                            }
                            )));
                        case 1:
            ...
            value: (n = o()(i.a.mark((function t(e) {
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 11:
                            return s = t.sent,
                            p.a.debug("Handling A9 Auction event on session " + n.id),
                            p.a.debug(e),
            ...
            value: (e = o()(i.a.mark((function t(e) {
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 11:
                            return s = t.sent,
                            p.a.debug("Handling A9 Impression event on session " + n.id),
                            p.a.debug(e),
                            ...
                            a.size = o.size,
                            a.amznsz = o.amznsz) : (p.a.warn("auction entry not found for impression: " + JSON.stringify(e)),
                            a.amzniid = e.amzniid,
                            a.amznp = e.amznp,
                            a.amznbid = e.amznbid,
                            a.cpm = e.cpm,
            ...
            value: function(t) {
                if (!t.amzniid)
                    throw p.a.error("missing 'amzniid'"),
                    new D;
                if (!t.amznbid)
                    throw p.a.error("missing 'amznbid'"),
                    new D;
                if (!t.amznp)
                    throw p.a.error("missing 'amznp'"),
                    new D;
                if (!t.slotName)
                    throw p.a.error("missing 'slotName'"),
                    new D;
            ...
            value: function(t) {
                ...
                w.emptyArray(t.request))
                    throw p.a.error("A9 auction data missing request object"),
                    new D;
                if (w.emptyArray(t.response))
                    throw p.a.error("A9 auction data missing response object"),
                    new D;
            ...
            value: function(t) {
                if (0 === Object.entries(this.lineItemsMap).length && this.lineItemsMap.constructor === Object)
                    throw p.a.error("A9 Line Items Map is empty, call init() to retrieve it"),
                    new q;
      ...
      , H = function() {
        function t(e, n) {
            u()(this, t),
            h()(this, "events", []),
            h()(this, "flushTimeoutId", null),
            h()(this, "flushTimeout", null),
            h()(this, "batchSize", null),
            this.flushTimeout = e,
            this.batchSize = n
        }
        var e, n, r, s, a;
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 2:
                            ...
                            return t.abrupt("return", J.a.get("https://analytics.leya.tech/a9/line-items", {
                                headers: {
                                    "x-api-token": e
                                }
                            }));
                        case 7:
                            p.a.warn("Can't retrieve line item map without an ingestion key, use Leya.setKey() to set yours.");
                        case 8:
                        case "end":
                            return t.stop()
                        }
                    ...
                    for (; ; )
                        ...
                        case 2:
                            ...
                            t.prev = 4; this.events.length; )
                                ...
                                p.a.debug("Flushing " + n.length + " events"),
                                n.length && function() {
                                    var t = {};
                                    ...
                                    e)
                                        if (navigator.sendBeacon) {
                                            ...
                                            J.a.post("https://analytics.leya.tech/events", JSON.stringify(t), {
                                                headers: {
                                        ...
                                        p.a.warn("missing ingestion key")
                                }();
                        case 6:
                            return t.prev = 6,
                            t.next = 9,
    ...
    !function(t) {
        ...
        Leya.startSession().then((function() {
            return p.a.info("Session Open")
        }
        )),
        e.scheduleFlush().then((function() {
            return p.a.info("Scheduled flush")
        }
        ));
        t.Leya = Object.assign({}, t.Leya, {
            Events: {
                ...
                A9: {
                    handleAuctionEvent: function(t) {
                        return i.handleAuctionEvent(t)
                    },
                    handleImpressionEvent: function(t) {
                        return i.handleImpressionEvent(t)
                    },
                    init: function() {
                        return i.init()
                    },
                    getLineItemsMap: function() {
                        return i.getLineItemsMap()
                    }
                },
                recordPageView: function() {
                    return r.recordPageView()
                },
                recordSession: function() {
                    return r.recordSession()
                }
            }
        })
    }(window)
    ...
    var r = n(1)
      ...
      , p = function() {
        function t() {
            u()(this, t),
            h()(this, "_consented", 3),
            h()(this, "_vendorListVersion", void 0)
        }
        return l()(t, [{
            key: "gdprDetails",
            value: function() {
      ...
      , _ = function() {
        function t() {
            ...
            h()(this, "tags", null),
            h()(this, "key", null),
            this.user = new g(m.b.getDeviceType(),m.b.getBrowserLanguage()),
            this.tags = []
        }
        var e, n, r, s, a, c, f, p, y, _, k;
        return l()(t, [{
            key: "setKey",
            value: (k = o()(i.a.mark((function t(e) {
                return i.a.wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 0:
                            ...
                            this.session = new d(v()()),
                            m.a.debug("Started new session " + this.session.id),
                            t.next = 10;
                            break;
                        case 5:
                            ...
                            throw m.a.error("A session is already open, close it before starting a new one"),
                            new b.a;
                        case 8:
                            this.session = new d(v()()),
                            m.a.debug("Started new session " + this.session.id);
                ...
                return i.a.wrap((function(t) {
                    for (; ; )
                        ...
                        case 0:
                            ...
                            return m.a.debug("Ending session " + this.session.id),
                            this.session.finish = (new Date).getTime(),
                            t.abrupt("return", Leya.Events.recordSession());
                        case 7:
                            m.a.warn("Session already closed at " + this.session.finish);
                        case 8:
                            t.next = 12;
                            break;
                        case 10:
                            throw m.a.error("No session, start one first"),
                            new w.a;
                        case 12:
                        case "end":
                            return t.stop()
            ...
            key: "setTags",
            value: (f = o()(i.a.mark((function t(e) {
                return i.a.wrap((function(t) {
                    for (; ; )
                        switch (t.prev = t.next) {
                        case 0:
